/**********************************
3. আরেকটা ফাংশন লিখবে যেটার নাম লিখবে। যেই ফাংশনের নাম হবে paperRequirements 
...
function paperRequirements(firstBook, secondBook, thirdBook) {
    pagesForFirstBook = firstBook * 100
    pagesForSecondBook = secondBook * 200
    pagesForThirdBook = thirdBook * 300
    totalPages = pagesForFirstBook + pagesForSecondBook + pagesForThirdBook
    return totalPages;
} 
    
const copyOfBooks = paperRequirements(4, 3, 5);
